...
public class Chatting extends AppCompatActivity {
    ...
    String Qgenre = "본 영화의 장르가 무엇인가요?";
    String Qgrade = "본 영화의 관람가 등급은 무엇인가요?";
    String Qactor = "본 영화에 주연으로 누가 출연하나요?";
    String Qdirector = "본 영화의 감독은 누구인가요?";
    String Qdate = "본 영화는 몇년도에 개봉했나요?";
...
//      Button ummBtn = (Button) findViewById(R.id.neutBtn);      // 모르겠습니다 버튼
        ...
        yesBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Iscorrect = true;
                //String message = "yes";             // 데이터 탐색 때 넘겨줄 답변정보 (for firebase)
                //printMessage("User", q);
